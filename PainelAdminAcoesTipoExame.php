...
<head>
    ...
    <!-- ARQUIVOS FAVICON -->
    <title>LACIF - Gerenciar Tipo Exame</title>
                ...
                <div class="col-12 col-lg-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Tipo de Exame</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Editar Tipo de Exame</li>
                        </ol>
                    </nav>
...
//                                    $dataBrasil = implode('/', array_reverse(explode('-', $linha['datanasc'])));
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            echo " ";
                                            $id = $linha['idTipoExame'];
                                            echo "<a href='#' title='Excluir' onclick='confirmacaoExclusaoTipoExame($id);'><i class='fa fa-trash'></i></a>";
                                            ?>
                                        </td>
                                    </tr>
                                    <?php
