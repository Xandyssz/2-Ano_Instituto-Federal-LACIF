...
if ($id > 0) {
    $query = "SELECT * FROM ifsp_lacif.carrossel WHERE idCarrossel = $id";
...
//Fazer o update no banco de dados
    ...
    $result = "UPDATE ifsp_lacif.carrossel 
    SET titulo = '$titulo', 
        descricao = '$descricao',
        ativo = '$ativo', 
        img_nome = '$img_nome'  
    ...
    echo '<meta HTTP-EQUIV="Refresh" CONTENT="0; URL=PainelAdminAcoesCarrossel.php">';
}
?>