...
?>
    ...
    <!--Header-->
    <title>LACIF - Editar Convênio</title>
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input class="form-control" id="nomeConvenio" name="nomeConvenio" type="text" value="<?php  echo $linhaUnica['nomeConvenio']; ?>"required>
                                        </div>
                                    </div>
...
set nomeConvenio = '$nomeConvenio' 
    ...
    echo '<meta HTTP-EQUIV="Refresh" CONTENT="0; URL=PainelAdminAcoesConvenio.php">';
