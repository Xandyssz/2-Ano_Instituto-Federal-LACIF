...
<div class="main-container">
    ...
    <div class="cards">
        ...
        ifsp_lacif.consultas.id,
        ifsp_lacif.consultas.title,
        ifsp_lacif.consultas.description,
        ifsp_lacif.consultas.start,
        ifsp_lacif.consultas.horario,
        ifsp_lacif.consultas.idconvenio,
        ifsp_lacif.consultas.celular,
        ifsp_lacif.consultas.resultado,
        ifsp_lacif.consultas.status,
        ifsp_lacif.exames.nomeExame,
        ifsp_lacif.exames.valor,
        ifsp_lacif.usuarios.nome,
        ifsp_lacif.usuarios.endereco,
        ifsp_lacif.usuarios.celular AS user_celular,
        ifsp_lacif.usuarios.email
    FROM
        ifsp_lacif.consultas
        ...
        <div class="box">
            <div class="card card-1">
                ...
                <a href="#" onclick="generatePDF()">Download Boletim Médic <i class='fa fa-file-pdf-o'></i></a>
                <?php
                if (!empty($row['resultado'])) {
                    echo "<a href='img/{$row['resultado']}'>Download do Resultado <i class='fa fa-file-pdf-o'></i></a>";
                } else {
                    echo "<span style='color: black;'>O resultado não está disponível no momento.</span>";
                }
                ?>
                    ...
                    <script>
                        ...
                        var props = {
                            ...
                            contact: {
                                name: "<?php echo $row['nome']; ?>",
                                address: "<?php echo $row['endereco']; ?>",
                            ...
                            invoice: {
                                ...
                                num: ":",
                                invDate: "<?php echo $row['start']; ?>;",
                                invGenDate: "<?php echo $row['horario']; ?>;",
                                headerBorder: false,
