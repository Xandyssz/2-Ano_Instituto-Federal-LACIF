...
//                                    $dataBrasil = implode('/', array_reverse(explode('-', $linha['datanasc'])));
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="badge badge-danger" href='PainelAdminAcoesNoticia.php?del=<?php echo $linha['idNoticia']?>'><i class="mdi mdi-delete"></i> Delete</a>
                                        <td><a class="badge badge-primary" href='PainelAdminEditarNoticia.php?p_id=<?php echo $linha['idNoticia']?>'><i class="mdi mdi-delete"></i> Editar</a>
