...
<!--Header-->
<title>LACIF - Cadastrar Tipo Exame</title>
                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Cadastrar Tipo Exame</li>
                        </ol>
                    </nav>
                    <div class="card card-border-color card-border-color-primary">
                        <div class="card-header card-header-divider">Adicionar Detalhes do Tipo Exame<span class="card-subtitle">Por favor, preencha os dados necessários.</span></div>
                        <div class="card-body">
                            <form method="POST">

                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="nomeExame">Digite o Tipo Exame</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input class="form-control" id="nomeExame" name="nomeExame" type="text" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <p class="text-right">
                                        ...
                                        <input type="button" name="listar" class="btn btn-primary pull-right" value="Cancelar" onclick="window.location.href='PainelAdminAcoesTipoExame.php'">
                                        <br>
                                </div>
                        </div>
                        <br>
