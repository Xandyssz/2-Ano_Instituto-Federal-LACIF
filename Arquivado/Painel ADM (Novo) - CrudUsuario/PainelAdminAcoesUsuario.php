...
//{
//    header("location: PainelAdminAcoesUsuario.php");
//}
//else
//{
                  ...
                  <thead>
                    ...
                    while ($linha = mysqli_fetch_assoc($dados)){
                        ...
                        <tr>
                            ...
                            <td><a class="badge badge-danger" href='PainelAdminAcoesUsuario.php?del=<?php echo $linha['><i class="mdi mdi-delete"></i> Delete</a>
                            <td><a class="badge badge-primary" href='PainelAdminEditarUsuario.php?p_id=<?php echo $linha['><i class="mdi mdi-delete"></i> Editar</a>
