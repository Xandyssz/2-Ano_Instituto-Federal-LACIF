...
//                                    $dataBrasil = implode('/', array_reverse(explode('-', $linha['datanasc'])));
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="badge badge-danger" href='PainelAdminAcoesConsulta.php?del=<?php echo $linha['id']?>'><i class="mdi mdi-delete"></i> Delete</a>
                                        <td><a class="badge badge-primary" href='PainelAdminEditarConsulta.php?p_id=<?php echo $linha['id']?>'><i class="mdi mdi-delete"></i> Editar</a>
